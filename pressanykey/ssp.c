...
//	SSP0->CPSR = 254;			//********
	...
	any_gpio_set_function(PIN_0_8, IOCON_IO_FUNC_PIO0_8_SSP);
	any_gpio_set_function(PIN_0_9, IOCON_IO_FUNC_PIO0_9_SSP);
	...
	any_gpio_set_function(PIN_2_11, IOCON_IO_FUNC_PIO2_11_SSP);
