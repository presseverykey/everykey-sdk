...
/** flags to use in the wChannelConfig field in input terminal descriptors */
typedef enum USB_AUDIO_CHANNELCONFIG_FLAGS {
	USB_AUDIO_CHANNELCONFIG_LEFT_FRONT		= 0x0001,
	USB_AUDIO_CHANNELCONFIG_RIGHT_FRONT		= 0x0002,
	USB_AUDIO_CHANNELCONFIG_CENTER_FRONT	= 0x0004,
	USB_AUDIO_CHANNELCONFIG_SUBWOOFER		= 0x0008,
	USB_AUDIO_CHANNELCONFIG_LEFT_SURROUND	= 0x0010,
	USB_AUDIO_CHANNELCONFIG_RIGHT_SURROUND	= 0x0020,
	USB_AUDIO_CHANNELCONFIG_LEFT_OF_CENTER	= 0x0040,
	USB_AUDIO_CHANNELCONFIG_RIGHT_OF_CENTER	= 0x0080,
	USB_AUDIO_CHANNELCONFIG_SURROUND		= 0x0100,
	USB_AUDIO_CHANNELCONFIG_SIDE_LEFT		= 0x0200,
