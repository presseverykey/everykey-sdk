...
typedef enum IOCON_IO_FUNC {
	IOCON_IO_FUNC_PIO0_0_RESET  = 0x00,
	IOCON_IO_FUNC_PIO0_0_PIO    = 0x01,

	IOCON_IO_FUNC_PIO0_1_PIO    = 0x00,
	IOCON_IO_FUNC_PIO0_1_CLK    = 0x01,
	IOCON_IO_FUNC_PIO0_1_TMR    = 0x02,
	IOCON_IO_FUNC_PIO0_1_USBTG  = 0x03,

	IOCON_IO_FUNC_PIO0_2_PIO    = 0x00,
	IOCON_IO_FUNC_PIO0_2_SSEL   = 0x01,
	IOCON_IO_FUNC_PIO0_2_TMR    = 0x02,
	...
	IOCON_IO_FUNC_PIO1_9_PIO    = 0x00,
	IOCON_IO_FUNC_PIO1_9_TMR    = 0x01,
	...
	IOCON_IO_FUNC_PIO2_4_PIO    = 0x00,

	IOCON_IO_FUNC_PIO2_5_PIO    = 0x00,

	IOCON_IO_FUNC_PIO2_6_PIO    = 0x00,

	IOCON_IO_FUNC_PIO2_7_PIO    = 0x00,

	IOCON_IO_FUNC_PIO2_8_PIO    = 0x00,

	IOCON_IO_FUNC_PIO2_9_PIO    = 0x00,

	IOCON_IO_FUNC_PIO2_10_PIO   = 0x00,

	IOCON_IO_FUNC_PIO2_11_PIO   = 0x00,
	IOCON_IO_FUNC_PIO2_11_SCK   = 0x01,	//Wrong value (0x02) in older versions of the user manual

	IOCON_IO_FUNC_PIO3_0_PIO    = 0x00,
